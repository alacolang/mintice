...
const Game12 = colorGameFactory(
  "12",
  pickColors(["yellow", "orange", "white"])
);
...
const Game16 = colorGameFactory("16", pickColors(["white", "black", "yellow"]));
const Game17 = colorGameFactory("17", pickColors(["blue", "grey", "pink"]));
const Game18 = colorGameFactory("18", pickColors(["white", "yellow", "blue"]));
